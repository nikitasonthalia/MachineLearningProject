...
object sparkweek3 {
  ...
  for( a <- 3 to 10){
 	...
 	val textFile = sc.textFile("/Users/vikashkamdar/Desktop/MLprojectOutput/train_week"+a+".csv")
   ...
   // val value = token(1) +"#"+ token(10);
	...
	counts.coalesce(1).saveAsTextFile("/Users/vikashkamdar/Desktop/MLprojectOutput/week"+a+"objectoutput")
}
}
  }