...
object sparkweek3 {
  ...
  val textFile = sc.textFile("/Users/vikashkamdar/Desktop/MLprojectOutput/train_week9.csv")
  ...
  counts.coalesce(1).saveAsTextFile("/Users/vikashkamdar/Desktop/MLprojectOutput/week9objectoutput")
}
  }